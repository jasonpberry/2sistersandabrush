...
/*
### NOTE: This file was last updated: 2023-08-30 17:20:31
...
return array (
  '                              example: field1, field2<br>
                              ...
                              <code>Example Url: viewer.php?record_title_goes_here-123</code>' => '                              example: field1, field2<br>
                              These fields are added to viewer links to create more descriptive urls for users<br>and search engines. The first field value that isn\'t blank is used.<br>
  ...
  '                <p>This section lets you control what search options are available on the <a href="?menu=%s">editor list page</a>.</p>
                ...
                </dl>' => '                <p>This section lets you control what search options are available on the <a href="?menu=%s">editor list page</a>.</p>
                <dl>
                  <dt><b>Disabling Search</b></dt>
                  <dd>If you don\'t want any search options displayed just leave the box above blank.<br><br></dd>
  ...
  '                These sorting settings are used for both the <a href="?menu=%s">editor</a> and the viewers (although viewers can override them).
                ...
                <b>Tip:</b>  The "Order By" field is actually just the standard MySQL ORDER BY clause of a SELECT statement.  So if you\'re familiar with MySQL you can enter any ORDER BY clause you want here.  Otherwise, congratulations! You just learned some MySQL!' => '                These sorting settings are used for both the <a href="?menu=%s">editor</a> and the viewers (although viewers can override them).
                Here are some common sorting values that can be used here and in the viewers. Use your own fieldnames instead of the <i>examples</i>.<br>
                <dl>
                  <dt><i>title, author</i></dt>
                  <dd>sort by title, then author<br><br></dd>
  ...
  '                These sorting settings are used for both the <a href="?menu=%s">editor</a> and the viewers (although viewers can override them).
                ...
                <b>Tip:</b>  The "Order By" field is actually just the standard MySQL ORDER BY clause of a SELECT statement.  So if you\'re familiar with MySQL you can enter any ORDER BY clause you want here.  Otherwise, congratulations! You just learned some MySQL!',
  '%1$s free of %2$s' => '%1$s free of %2$s',
  '%s seconds' => '%s seconds',
  '&lt;&lt;  prev' => '&lt;&lt;  prev',
  '&lt;select&gt;' => '&lt;select&gt;',
  ...
  '(displayed in section editor field list only)' => '(displayed in section editor field list only)',
...
',
  ...
  'Admin' => 'Admin',
  'Admin / From Email' => 'Admin / From Email',
  ...
  'Any error messages or error logs are sent to this email address.' => 'Any error messages or error logs are sent to this email address.',
  ...
  'Automatically convert image uploads to WebP format' => 'Automatically convert image uploads to WebP format',
  'Automatically encrypt data stored in database' => 'Automatically encrypt data stored in database',
  ...
  'Completed' => 'Completed',
  'Connections: Encrypt the connection between PHP and the database server' => 'Connections: Encrypt the connection between PHP and the database server',
  ...
  'Database Data: Allow columns to be encrypted using this key: ' => 'Database Data: Allow columns to be encrypted using this key: ',
  ...
  'Disable Erase From Modify Page' => 'Disable Erase From Modify Page',
  'Disable HTML5 Uploader' => 'Disable HTML5 Uploader',
  'Disable HTML5 Uploader - attach one file at a time (doesn\'t require html5 support)' => 'Disable HTML5 Uploader - attach one file at a time (doesn\'t require html5 support)',
  ...
  'Don\'t allow removing records from the modify page' => 'Don\'t allow removing records from the modify page',
  ...
  'Enable Media Library that allows using uploads in multiple sections' => 'Enable Media Library that allows using uploads in multiple sections',
  ...
  'Encrypted connection support' => 'Encrypted connection support',
  ...
  'Generate an RSS Feed for visitors to subscribe to.' => 'Generate an RSS Feed for visitors to subscribe to.',
  ...
  'Hide all warnings and show "An unexpected error occurred #" for errors.  <a href=\'?menu=_error_log\'>View error log &gt;&gt;</a>' => 'Hide all warnings and show "An unexpected error occurred #" for errors.  <a href=\'?menu=_error_log\'>View error log &gt;&gt;</a>',
  ...
  'Insert field above' => 'Insert field above',
  ...
  'Legacy Code Generators' => 'Legacy Code Generators',
  'License' => 'License',
  ...
  'Limits the Scheduled Task log to a maximum number of entries. This can be used to reduce disk space usage on sites with many Scheduled Tasks. Set to 0 for no limit.' => 'Limits the Scheduled Task log to a maximum number of entries. This can be used to reduce disk space usage on sites with many Scheduled Tasks. Set to 0 for no limit.',
  'Limits the Scheduled Task log to a maximum number of entries. This can be used to reduce disk space usage on sites with many scheduled tasks. Set to 0 for no limit.' => 'Limits the Scheduled Task log to a maximum number of entries. This can be used to reduce disk space usage on sites with many scheduled tasks. Set to 0 for no limit.',
  ...
  'Logoff (%s)' => 'Logoff (%s)',
  'MEDIUMBLOB (max: 16 megs)' => 'MEDIUMBLOB (max: 16 megs)',
  ...
  'Password' => 'Password',
  'Password Field - hide text that users enter (show values as *****)' => 'Password Field - hide text that users enter (show values as *****)',
  'Per Page' => 'Per Page',
  ...
  'Scheduled Task Log Limit' => 'Scheduled Task Log Limit',
  'Scheduled Task logs have been cleared.' => 'Scheduled Task logs have been cleared.',
  'Scheduled Tasks' => 'Scheduled Tasks',
  'Scheduled Tasks Log >>' => 'Scheduled Tasks Log >>',
  'Scheduled Tasks allow programs to run in the background at specific times for tasks such as maintenance, email alerts, etc.
You don\'t need to enable this feature unless you have a plugin that requires it.' => 'Scheduled Tasks allow programs to run in the background at specific times for tasks such as maintenance, email alerts, etc.
You don\'t need to enable this feature unless you have a plugin that requires it.',
  'Scheduled Tasks logs have been cleared.' => 'Scheduled Tasks logs have been cleared.',
  'Scheduled tasks allow programs to run in the background at specific times for tasks such as maintenance, email alerts, etc.
You don\'t need to enable this feature unless you have a plugin that requires it.' => 'Scheduled tasks allow programs to run in the background at specific times for tasks such as maintenance, email alerts, etc.
You don\'t need to enable this feature unless you have a plugin that requires it.',
...
',
  ...
  'Task Log' => 'Task Log',
  'Temporarily disable Scheduled Tasks (for debugging or maintenance)' => 'Temporarily disable Scheduled Tasks (for debugging or maintenance)',
  'Temporarily disable scheduled tasks (for debugging or maintenance)' => 'Temporarily disable scheduled tasks (for debugging or maintenance)',
  'Text Link' => 'Text Link',
  ...
  'These code generators shipped with earlier versions of the software.  The viewers they create will work forever, but this section will be removed in future.' => 'These code generators shipped with earlier versions of the software.  The viewers they create will work forever, but this section will be removed in future.',
...
<b>Tip:</b>  The "Order By" field is actually just the standard MySQL ORDER BY clause of a SELECT statement.  So if you\'re familiar with MySQL you can enter any ORDER BY clause you want here.  Otherwise, congratulations! You just learned some MySQL!',
  ...
  'This email is used as the "From:" address on outgoing emails such as password reminders, etc.' => 'This email is used as the "From:" address on outgoing emails such as password reminders, etc.',
  ...
  'Tiny' => 'Tiny',
  'Tip: <a href=\'?menu=admin&action=backuprestore\'>Backup database</a> before encrypting so you have an unencrypted copy of your data.' => 'Tip: <a href=\'?menu=admin&action=backuprestore\'>Backup database</a> before encrypting so you have an unencrypted copy of your data.',
  'Tip: Backup this key, without it your data will be unrecoverable!' => 'Tip: Backup this key, without it your data will be unrecoverable!',
  'Tip: This encryption key is only used when you enable \'data encryption\' on specific fields in the field editor.' => 'Tip: This encryption key is only used when you enable \'data encryption\' on specific fields in the field editor.',
  'Tip: Use the same encryption key on all development and production copies of a website.' => 'Tip: Use the same encryption key on all development and production copies of a website.',
  ...
  'To change %1$s settings edit: %2$s' => 'To change %1$s settings edit: %2$s',
  'To setup Scheduled Tasks, add a server cronjob or \'scheduled task\' to execute the following command every minute:' => 'To setup Scheduled Tasks, add a server cronjob or \'scheduled task\' to execute the following command every minute:',
  ...
  'Version' => 'Version',
  'View' => 'View',
  'View Errors and Warnings' => 'View Errors and Warnings',
  ...
  'Warning: Scheduled Tasks have not run in the last hour, please follow the instructions below to enable Scheduled Tasks.' => 'Warning: Scheduled Tasks have not run in the last hour, please follow the instructions below to enable Scheduled Tasks.',
  'Warning: Scheduled tasks have not run in the last hour, please follow the instructions below to enable scheduled tasks.' => 'Warning: Scheduled tasks have not run in the last hour, please follow the instructions below to enable scheduled tasks.',
  ...
  'choose if field has edit access restrictions.' => 'choose if field has edit access restrictions.',
  'clear all' => 'clear all',
