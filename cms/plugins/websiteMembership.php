...
$GLOBALS['WEBSITE_LOGIN_LOGIN_FORM_URL'] = PREFIX_URL . '/clients'; // url to login form
$GLOBALS['WEBSITE_LOGIN_SIGNUP_URL'] = PREFIX_URL . '/user-signup.php'; // signup url linked to from the login page
$GLOBALS['WEBSITE_LOGIN_REMINDER_URL'] = PREFIX_URL . '/clients/forgot-password/'; // password reminder url linked to from the login page
$GLOBALS['WEBSITE_LOGIN_PROFILE_URL'] = PREFIX_URL . '/user-profile/'; // url to "edit my profile" page
...
$GLOBALS['WEBSITE_LOGIN_POST_LOGIN_URL'] = PREFIX_URL . '/clients/profile/';

// After logoff, user gets redirected to the last page they were on (if defined), the url below, or to /
$GLOBALS['WEBSITE_LOGIN_POST_LOGOFF_URL'] = PREFIX_URL . '/clients/';
